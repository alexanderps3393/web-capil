...
echo "<div class='wrapper'>			
	<div class='header-logo' style='margin-top: 0px' >";
		  ...
		  foreach ($logo->result_array() as $row) {
			...
			echo "<a href='".base_url()."'><img src='".base_url()."asset/logo/logo.png'/></a>";
		  }
	echo "</div>	

	<div class='header-menu' style='margin-top: 5px'>
		<ul>";
		...
		echo "</ul><p>$iden[meta_deskripsi] hubungi kami di : $iden[no_telp] - $iden[email]</p>
	</div>
...
<div class='secondary-menu'>
	<div class='wrapper'>
		<ul>";
				$tag = $this->model_utama->view_ordering_limit('tag','id_tag','RANDOM',0,10);
