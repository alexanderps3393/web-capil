...
<html>
  <head>
    ...
    <!-- <link rel="stylesheet" href="<?php echo base_url(); ?>asset/admin/dist/css/skins/_all-skins.min.css"> -->
     <link rel="stylesheet" href="<?php echo base_url(); ?>asset/admin/dist/css/skins/skin-green.min.css">
    <!-- iCheck -->
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class='alert alert-warning alert-dismissible fade in' role='alert' style='border-radius:0px; margin-bottom:0px'>
          ...
          <a target='_BLANK' class="btn btn-default btn-sm" href="https://members.phpmu.com/" style="color: rgb(243, 156, 18);">Kejari-kendari.go.id</a>
        </div>
      <?php } ?>
