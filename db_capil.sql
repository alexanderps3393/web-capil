...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2017 at 04:47 PM
...
) ENGINE=MyISAM AUTO_INCREMENT=674 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
(31, 'sdfdfsdf', '6.jpg', '2017-01-27', 2);
...
(1, 'DINAS KEPENDUDUKAN DAN PENCATATAN SIPIL KOTA KENDARI', 'dispendukcapil@gmail.com', 'http://localhost/capilkendari', 'https://www.facebook.com/capilkendari, https://twitter.com/capil_kendari', '', '', 'Dinas Kependudukan dan Pencatatan SIpil Kota Kendari', 'Capil Kendari, Dinasi Kependudukan Kendari, Daftar KTP Kendari, Capil', 'favicon1.png', '');
...
(1, 'Jasa Pembuatan Website murah', 'admin', 'http://phpmu.com', 'header3.png', '2017-10-04');
...
(3, 'Iklan Home No 3', 'admin', 'http://phpmu.com', 'home.swf', '2015-03-17'),
...
`id_komentar` int(5) NOT NULL,
  ...
  `aktif` enum('Y','N') COLLATE latin1_general_ci NOT NULL DEFAULT 'Y',
  `email` varchar(100) COLLATE latin1_general_ci NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=155 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
(9, 7, 'BERANDA', 'BERANDA', 'Ya', 'Top', 0),
(8, 0, 'BERITA', '#', 'Ya', 'Bottom', 2),
(7, 0, 'BERANDA', 'main', 'Ya', 'Bottom', 1),
(11, 8, 'Visi dan Misi', 'kategori/detail/politik', 'Ya', 'Bottom', 3),
(12, 8, 'Perintah Harian Jaksa Agung', 'kategori/detail/ekonomi', 'Ya', 'Bottom', 2),
(13, 0, 'PROFIL KEPENDUDUKAN', 'kategori/detail/internasional', 'Ya', 'Bottom', 3),
(18, 0, 'PELAYANAN KAMI', 'playlist', 'Ya', 'Bottom', 4),
(19, 0, 'TENTANG KAMI', 'albums', 'Ya', 'Bottom', 7),
(129, 18, 'Perdata dan TUN', '#', 'Ya', 'Bottom', 2),
(109, 8, 'Kata Sambutan', '#', 'Ya', 'Bottom', 0),
(110, 8, 'Tentang Kejari Kendari', '#', 'Ya', 'Bottom', 1),
(112, 18, 'Pidana Khusus', '#', 'Ya', 'Bottom', 1),
...
(117, 0, 'KONTAK', 'download', 'Ya', 'Bottom', 8),
(118, 0, 'SUARA ANDA', 'agenda', 'Ya', 'Bottom', 9),
(119, 0, 'Index Berita', 'berita/indeks_berita', 'Ya', 'Top', 1),
(130, 18, 'Inteligen', '#', 'Ya', 'Bottom', 3),
(126, 18, 'Pidana Umum', '#', 'Ya', 'Bottom', 0);
...
('::1', '2017-09-22', 3, '1506091081'),
('::1', '2017-09-24', 1, '1506218819'),
('::1', '2017-10-01', 1, '1506853964'),
('::1', '2017-10-04', 64, '1507122488'),
('::1', '2017-10-08', 17, '1507415962'),
('::1', '2017-10-15', 1, '1508067765'),
('::1', '2017-10-16', 2, '1508156337'),
('::1', '2017-10-22', 1, '1508664784'),
('::1', '2017-10-29', 2, '1509274811'),
('::1', '2017-11-09', 1, '1510229701'),
('::1', '2017-11-10', 1, '1510315756'),
('::1', '2017-11-12', 51, '1510501498');
...
(22, 'Penjara', 'admin', 'penjara', 19),
(26, 'Pemerkosaan', 'admin', 'pemerkosaan', 42),
(25, 'Info Kejaksaan', 'admin', 'info-kejaksaan', 16),
(24, 'PCC', 'admin', 'pcc', 11),
(34, 'Pembunuhan', 'admin', 'pembunuhan', 4),
(36, 'Pembinaan', 'admin', 'pembinaan', 16),
(37, 'Inteligen', 'admin', 'inteligen', 25),
(40, 'Pidana Khusus', 'admin', 'pidana-khusus', 28),
(41, 'Pidana Umum', 'admin', 'pidana-umum', 21),
(43, 'Pemerintah', 'admin', 'pemerintah', 9),
(49, 'Hukum', 'admin', 'hukum', 6),
(50, 'Narkoba', 'admin', 'narkoba', 3),
(51, 'Korupsi', 'admin', 'korupsi', 4);
...
(17, 'Capil Kendari', 'admin', 'Ilham J.E', 'phpmu-tigo', 'Y');
...
('admin', 'bff0cc42103de1b4721370e84dc24f635a7afeca41198c9b3e03946a1b6b7191d14356408a5e57ce6daf77e6e800c66fac7ab0482d57d48d23e6808e4b562daa', 'Ilham Julian Efendi', 'ilham5566@gmail.com', '081267771344', 'ilhamWeb.jpg', 'admin', 'N', 'q173s8hs1jl04st35169ccl8o7');
...
--
ALTER TABLE `berita`
MODIFY `id_berita` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=674;
--
...
--
ALTER TABLE `iklanatas`
MODIFY `id_iklanatas` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `komentar`
MODIFY `id_komentar` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=155;
--
...
--
ALTER TABLE `menu`
MODIFY `id_menu` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=131;
--
